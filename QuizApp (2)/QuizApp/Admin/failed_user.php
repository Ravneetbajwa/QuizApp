...
if ($_POST['test'] == 'test2_table') {
    $query = 'select * from results where test = "Test 2" AND status="FAILED"';
} else {
    $query = 'select * from results where test = "Test 1" AND status="FAILED"';
}
...
<?php include_once './option_menu.php'; ?>
            ...
            <div class="column is-5">
                <label class="label"> FAILED USERS</label>
            </div>
